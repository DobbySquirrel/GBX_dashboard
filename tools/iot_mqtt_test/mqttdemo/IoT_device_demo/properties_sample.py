...
def report_drone_properties(iot_client):
    ...
    drone_delivery_order_property.add_service_property(service_id="DroneDeliveryOrder", property='RFID', value="RFID987654321")
...
def run():
    ...
    #                             secret='f61da3f4d2738a9bb3de', is_ssl=False)
    # drone_client = IotClient(drone_cfg)
    # drone_client.connect()
    # drone_client.start()
    # drone_client.subscribe(r'$oc/devices/' + '6729c1a340428521209c0759_WareHouse_Reader01'+ r'/sys/properties/report')
